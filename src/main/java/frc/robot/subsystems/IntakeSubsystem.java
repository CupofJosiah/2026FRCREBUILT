...
//     new NovaWrapper(rollerNova, DCMotor.getFalcon500(1), smcConfig);
...
//   private SmartMotorController intakePivotController = new SparkWrapper(pivotMotor, DCMotor.getFalcon500(1),
