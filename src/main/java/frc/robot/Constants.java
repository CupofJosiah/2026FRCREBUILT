...
public final class Constants {
  ...
  final double LOOP_TIME = 0.13; // s, 20ms + 110ms spark max velocity lag
  ...
  public static class ShooterConstants {
    ...
    public static final double shooterKV = 0.11987;
  ...
  public static class IntakeConstants {
    ...
    public static final int kPivotMotorId = 13; //30
    public static final int kRollerMotorId = 11; //31
  }

  // Hopper subsystem CAN IDs start at 40
  public static class HopperConstants {
    public static final int kHopperMotorId = 9;//40
  }

  // Kicker subsystem CAN IDs start at 50
  public static class KickerConstants {
    public static final int kKickerMotorId = 8;//50
  }
}