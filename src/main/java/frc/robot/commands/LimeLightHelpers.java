...
public class LimeLightHelpers {
  ...
  public static URL getLimelightURLString(String tableName, String request) {
    ...
    try {
      ...
      Logger.recordOutput("Limelight/Error", "MalformedURLException: " + e.getMessage());
    }
    return null;
  }
  /////
  ...
  private static boolean SYNCH_TAKESNAPSHOT(String tableName, String snapshotName) {
    ...
    try {
      ...
      if (responseCode == 200) {
        ...
        Logger.recordOutput("Limelight/Error", "Bad LL Request - Response Code: " + responseCode);
      }
    } catch (IOException e) {
      Logger.recordOutput("Limelight/Error", "IOException: " + e.getMessage());
    }
    return false;
  }
